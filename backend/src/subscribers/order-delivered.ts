...
export default async function orderDeliveredHandler({
  ...
  const emailTemplate = `
    ...
    <p>Your order has been delivered to the specified address. Here are the details of your order:</p>
    ...
    <p>Thank you for choosing Kriolas Vintage!<br>The Kriolas Vintage Team</p>
  `;
